            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-slate-50/50">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-semibold tracking-tight text-slate-900 text-sm">Thông báo</h3>
                  {unreadCount > 0 && (
                    <span className="ml-auto inline-flex items-center justify-center w-5 h-5 text-[10px] font-semibold tracking-tight text-white bg-rose-500 rounded-full tabular-nums">
                      {unreadCount}
                    </span>
                  )}
                </div>
                      ...
                      >
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex-1 min-w-0">
                            <p className={`text-sm font-medium tracking-tight text-slate-900 truncate ${!notification.isRead ? 'font-semibold' : ''}`}>
                              {notification.title}
                            </p>

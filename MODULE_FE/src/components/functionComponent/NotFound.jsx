      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-cyan-500 to-blue-600 p-12 text-center">
            <div className="text-8xl font-semibold tracking-tight text-white animate-bounce tabular-nums">404</div>
          </div>

          {/* Content */}
          <div className="p-8 text-center">
            <h1 className="text-3xl font-semibold tracking-tight text-slate-800 mb-3">Trang không tìm thấy</h1>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold tracking-tight py-3 px-6 rounded-xl hover:shadow-lg transition transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
              >
                <Home size={20} />
                Trang chủ
              </button>
              ...
              <button
                ...
                className="w-full border-2 border-cyan-500 text-cyan-600 font-semibold tracking-tight py-3 px-6 rounded-xl hover:bg-cyan-50 transition active:scale-95 flex items-center justify-center gap-2"
              >
                <LogIn size={20} />
                Đăng nhập
              </button>
